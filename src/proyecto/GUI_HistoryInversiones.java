...
public class GUI_HistoryInversiones extends JPanel {
	...
	public GUI_HistoryInversiones() {
		...
		lblHistorialDeInversiones.setBounds(0, 31, 785, 55);
		add(lblHistorialDeInversiones);
		
		
		if(GUI_Principal.idioma.equals("Maya")) {
			lblHistorialDeInversiones.setText("Tinaj u jachal yuumkabtalalo' k'ajoolal");
		} else {
			lblHistorialDeInversiones.setText("Historial de inversiones realizadas");
		}
	}
