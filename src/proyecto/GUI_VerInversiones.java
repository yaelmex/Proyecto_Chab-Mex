...
public class GUI_VerInversiones extends JPanel {
	...
	public GUI_VerInversiones() {
		...
		if(GUI_Principal.idioma.equals("Maya")) {
			lblRegistroInversiones.setText("Tinaj u jachal yuumkabtalalo' k'ajoolal");
			btnRetiraInv.setText("K'exbal yuumkabtalal");
		} else {
			lblRegistroInversiones.setText("Registro de inversiones realizadas");
			btnRetiraInv.setText("Retirar Inversión");
		}
